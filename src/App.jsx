...
export default function App() {
    ...
    // ALTERAÇÃO 1: Tema Padrão agora é "dark"
    const [theme, setTheme] = useState(() => {
        if (typeof window !== "undefined") {
            // Se já tiver salvo, usa o salvo, se não, usa 'dark'
    ...
    useEffect(() => {
        // Título dinâmico
        document.title = "GuriCell - Assistência Técnica em Dourados";
    }, []);
    ...
    const products = [
        { name: "iPhone 15 Pro Max", price: "Consulte", image: "https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=400&q=80", badge: "Em Estoque" },
        { name: "Xiaomi Redmi Note 13", price: "Oferta", image: "https://images.unsplash.com/photo-1598327105666-5b89351aff97?w=400&q=80", badge: "Mais Vendido" },
        { name: "Samsung S24 Ultra", price: "Consulte", image: "https://images.unsplash.com/photo-1610945415295-d9bbf067e59c?w=400&q=80", badge: "Lançamento" },
        { name: "iPhone 13 (Seminovo)", price: "Oportunidade", image: "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=400&q=80", badge: "Revisado" },
        { name: "Carregador 20W", price: "Promoção", image: "https://images.unsplash.com/photo-1583863788434-e58a36330cf0?w=400&q=80", badge: "Acessório" },
    ];
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] font-sans text-gray-900 dark:text-gray-100 overflow-x-hidden transition-colors duration-300 selection:bg-yellow-500 selection:text-black">
                ...
                <div className="container mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex flex-col items-center group/logo cursor-pointer">
                            <div className="border-[3px] border-gray-900 dark:border-white rounded-lg px-1 py- transition-colors duration-300 hover:scale-110 transform">
                                <span className="font-black text-2xl md:text-3xl tracking-tighter uppercase flex gap-1 leading-none">
                                    ...
                                    <span className="text-[#FF0000]">CELL</span>
                                </span>
                            </div>
                            <div className="hidden lg:flex flex-col items-center mt-1 space-y-0.5">
                                <span className="text-[0.4rem] font-bold tracking-widest text-gray-800 dark:text-gray-200 leading-none">
                                    ASSISTÊNCIA TÉCNICA & ACESSORIOS
                                </span>
                            </div>
                        </div>
                ...
                <div className="container mx-auto relative z-10">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                            ...
                            {/* ALTERAÇÃO 2: Removido o badge "Desde 2024" daqui */}
                            ...
                            {/* ALTERAÇÃO 3: Nova frase de impacto */}
            ...
            {/* PRODUCTS */}
            <section id="produtos" className="py-20 px-4 overflow-hidden bg-gray-50 dark:bg-black">
                <div className="container mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
                        <div>
                            <span className="text-yellow-600 dark:text-yellow-500 font-bold tracking-wider uppercase text-sm">Vitrine GuriCell</span>
                            <h2 className="text-3xl md:text-4xl font-extrabold mt-2 text-gray-900 dark:text-white">Chegou na Loja</h2>
                        </div>
                        <a href={whatsappLink} className="text-gray-900 dark:text-white font-bold hover:text-yellow-600 dark:hover:text-yellow-500 flex items-center gap-2 transition-colors">
                            Ver catálogo completo no WhatsApp <ArrowRight className="w-4 h-4" />
                        </a>
                    </div>
                        ...
                        >
                            {products.map((product, index) => (
                                <SwiperSlide key={index} className="h-auto">
                                    <div className="group h-full bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 hover:border-black dark:hover:border-yellow-500 p-4 transition-all duration-300 relative flex flex-col">
                                        <div className="relative aspect-[4/5] mb-4 overflow-hidden rounded-xl bg-gray-100 dark:bg-gray-800">
                                            <img src={product.image} alt={product.name} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                                            <span className="absolute top-3 left-3 bg-black dark:bg-yellow-500 text-white dark:text-black text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wide">
                                                {product.badge}
                                            </span>
                                        </div>
                                        <div className="mt-auto">
                                            <h3 className="font-bold text-gray-900 dark:text-white text-lg mb-1 truncate">{product.name}</h3>
                                            <div className="flex items-center justify-between mt-3">
                                                <span className="text-gray-500 dark:text-gray-400 text-sm font-medium">{product.price}</span>
                                                <button className="bg-gray-100 dark:bg-gray-800 hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black p-2 rounded-lg transition-colors">
            ...
            {/* SOCIAL PROOF */}
            {/* SOCIAL PROOF - Estilo Google Reviews (Manual e Rápido) */}
<section className="py-20 px-4 bg-white dark:bg-[#0F0F0F] border-y border-gray-100 dark:border-gray-900">
                <div className="container mx-auto">
                    ...
                    <div className="w-full min-h-[300px]"> 
                        {/* O ID abaixo é o seu específico que você mandou */}
            ...
            {/* CONTACT */}
                ...
                {/* Efeito de grade no fundo do contato */}
